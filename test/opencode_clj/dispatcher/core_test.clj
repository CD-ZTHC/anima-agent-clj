(ns opencode-clj.dispatcher.core-test
  "Tests for the Event Dispatcher core module."
  (:require [clojure.test :refer [deftest is testing use-fixtures]]
            [clojure.core.async :as async]
            [opencode-clj.dispatcher.core :as core]
...
(deftest create-dispatcher-test
  (testing "Creating dispatcher with defaults"
    (let [dispatcher (core/create-dispatcher {})]
      ...
      (is (instance? opencode_clj.dispatcher.balancer.Balancer (:balancer dispatcher)))
      (is (instance? opencode_clj.dispatcher.circuit_breaker.CircuitBreaker (:circuit-breaker dispatcher)))
